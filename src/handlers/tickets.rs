...
use crate::models::{project, status, ticket, ticket_type, user};
...
fn load_project_members(conn: &rusqlite::Connection, project_id: i64) -> Vec<SelectOption> {
...
fn load_project_tickets(conn: &rusqlite::Connection, project_id: i64) -> Vec<SelectOption> {
...
pub async fn transition(
    ...
    // Validate both statuses active in project
